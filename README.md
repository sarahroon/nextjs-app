...
•	http://localhost:3001/ I created a form which saves comments to a dedicated comments table, the comments are connected to the posts table with a foreign key. It’s in the folder posts then the file [postid].js in my code in my GitHub repo.
...
- I styled lighter text against a darker background so users can easily read the content.
